...
if [ ! $? -eq 0 ]; then
    printf "\nAu native data version 0 FAILED to update!\n"
...
if [ ! $? -eq 0 ]; then
    printf "\nAu native data version 1 FAILED to update!\n"
...
if [ ! $? -eq 0 ]; then
    printf "\nAu native data version 2 FAILED to update!\n"
...
if [ ! $? -eq 0 ]; then
    printf "\nAu native data version 3 FAILED to update!\n"
    rm update_Au_3_temp.sh
    exit 1
fi
rm update_Au_3_temp.sh