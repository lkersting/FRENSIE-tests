...
if __name__ == "__main__":
    ...
    entity_ids = [1, 18, 16]
    radii = [1, 2, 5]
    top_ylims = [ [0.0, 12.5], [0.0, 4.3], [0.0, 1.3] ]
    bottom_ylims = [ [0.965, 1.035], [0.965, 1.035], [0.965, 1.035] ]
    xlims = [0.0,0.01]
    legend_pos = [ 1, 1, 1 ]
    ...
    forward_data = [None]*len(entity_ids)
    adjoint_data = [None]*len(entity_ids)
    ...
    output_data_name = output + 'Pb_0.01_uniform_brem_only'
