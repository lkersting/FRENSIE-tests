...
from infinite_medium_simulation import runForwardUniformEnergyInfiniteMediumSimulation
...
if __name__ == "__main__":
    ...
    # Run the simulation
    runForwardUniformEnergyInfiniteMediumSimulation( options.sim_name,
                                                     options.db_path,
                                                     "../../../infinite_medium.h5m",
