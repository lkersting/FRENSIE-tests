...
from infinite_medium_simulation import runAdjointUniformEnergyInfiniteMediumSimulation
...
if __name__ == "__main__":
    ...
    # Run the simulation
    runAdjointUniformEnergyInfiniteMediumSimulation( options.sim_name,
                                                     options.db_path,
                                                     "../../../infinite_medium.h5m",
